...
#### Results
I first looked at whether there was a correlation between airport size and how frequent delays occurred. Delays are defined as flights departing >15 minutes after schedule. 
...
I also looked at which airports correct delays. I called instances of an airplane arriving late but departing on time on its next flight as correctDelays, and analyzed which airports
...
There doesn't seem to be any correlation between how many flights an airport operates and how well it can recover from delays. 
